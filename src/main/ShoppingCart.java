/*
 * Class of methods to work with an ArrayList of products
 * 1. Add to ArrayList ("Shopping cart")
 * 2. Remove from ArrayList ("Remove from cart") - unused, but could be used to expand program
 * 3. Clear cart
 * 4. Sum of cart (subtotal)
 * 5. Calculates tax of cart for subtotal purposes
 * 6. Prints subtotal, tax and grand total
 */
